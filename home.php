  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">is a Website that allows you to search for scientific journals of both A and B in addition to the lists of opportunistic journals and editors (Predators), all the information are imported from Directorate  General for Scientific Research and Technological Development  official website  </p>
        <p class="lead">
          <a href="http://dgrsdt.dz/Ar/?fc=News_A&id=91" class="btn btn-lg btn-secondary">Learn more</a>
        </p>
      </main>
