...
if (isset($_GET['search'])) {
    ...
    if ($_GET['class'] == 'ALL') {
        ...
        $query_phrase1 = "SELECT* FROM table1 WHERE  $_class (titre LIKE '%$searchq%' OR publisher LIKE '%$searchq%'  )";
        $query_phrase  = "SELECT* FROM table1 WHERE  $_class (titre LIKE '%$searchq%' OR publisher LIKE '%$searchq%') LIMIT " . $offset . " ," . $items_per_page;
    }
    ...
    $query1 = mysqli_query($conn, $query_phrase1) or die("Can't execute Query1");
        ...
        <form action="index1.php" method="get">
          <div class="input-group">
            ...
            <select class="mdb-select md-form" name="class">
              ...
              <option value="predateurs">PREDATEURS</option>
            </select>
...
for ($i = 1; $i < $total_page; $i++) {
    $pageurl = "http://127.0.0.1/dashboard/journals-for-dz-phd.-master%20(1)%20-%20Copie/journals-for-dz-phd.-master/index1.php?search=$searchq&page=$i&class=$class";
    if ($page == $i) {
